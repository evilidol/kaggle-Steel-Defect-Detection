...
class FPAv2(nn.Module):
    ...
    def forward(self, x):
        ...
        x_glob = F.upsample(x_glob, scale_factor=(h, w), mode='bilinear', align_corners=True)  # 256, 16, 16
...
class Res34Unetv4(nn.Module):
    def __init__(self, classes=1):
        ...
        self.logit = nn.Sequential(nn.Conv2d(320, 64, kernel_size=3, padding=1),
                                   nn.ELU(True),
                                   nn.Conv2d(64, self.classes, kernel_size=1, bias=False))
...
if __name__ == "__main__":
    ...
    # tw.draw_model(resnet, [1, 3, 256, 256])
