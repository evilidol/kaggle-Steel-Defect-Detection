...
def index_to_onehot(index, num_class=4):
    onehot = index.repeat(1,num_class,1,1)
    arange  = torch.arange(1,num_class+1).view(1,num_class,1,1).to(index.device)
...
def draw_predict_result_attention(
    image, truth_mask, truth_label, truth_attention, probability_label, attention):
